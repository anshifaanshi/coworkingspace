    ...
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle 
                ...
                textHighlightClass="text-[#4682B4]" // Pass Steel Blue for highlights instead of pink
            />
                ...
                <div className="flex items-center justify-center py-5 overflow-hidden">
                    {[...testimonialsData, ...testimonialsData].map((testimonial, index) => (
                        <TestimonialCard 
                            ...
                            highlightColor="#4682B4" // Replace pink in card with Steel Blue
                        />
                    ))}
                </div>
            </Marquee>
                ...
                <div className="flex items-center justify-center py-5 overflow-hidden">
                    {[...testimonialsData, ...testimonialsData].map((testimonial, index) => (
                        <TestimonialCard 
                            ...
                            index={index} 
                            testimonial={testimonial} 
                            highlightColor="#4682B4" // Steel Blue
                        />
                    ))}
                </div>
            </Marquee>
